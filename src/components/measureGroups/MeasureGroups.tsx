...
const MeasureGroups = () => {
  ...
  const [visibileStrats, setVisibleStrats] = useState<number>(2);
              ...
              <MenuItemContainer>
                ...
                {formik.values.scoring !== "Ratio" && (
                  <MenuItem
                    ...
                    onClick={() => {
                      setVisibleStrats(formik.values.stratifications.length);
                        ...
                        <Row>
                          <Col>
                                ...
                                <span>
                                  ...
                                  <Button
                                    onClick={(e) => {
                                      ...
                                      flipSuccess();
                                      setVisibleStrats(visibileStrats - 1);
                                    }}
                                    buttonTitle="Remove"
                                    variant="white"
                                    buttonSize="sm"
                            ...
                            <TextField
                              ...
                              label=""
                              value={
                                formik.values.stratifications[i].cqlDefinition
                              }
                              inputProps={{
