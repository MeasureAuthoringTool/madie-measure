...
describe("HowItWorks", function () {
  it("renders the 'How it works' link by default", function () {
    ...
    expect(
      react_1.screen.queryByTestId("how-it-works-content")
    ).not.toBeInTheDocument();
  });
  it("opens the info section when the link is clicked", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        expect(
          react_1.screen.getByText(/To complete this process:/)
        ).toBeInTheDocument();
        return [2 /*return*/];
      });
    });
  });
  it("displays steps including the nested view-test-case guidance", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        (0, react_1.render)(<HowItWorks_1.default />);
        user_event_1.default.click(
          react_1.screen.getByTestId("how-it-works-link")
        );
        expect(
  ...
  it("closes the info section when the X button is clicked", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        (0, react_1.render)(<HowItWorks_1.default />);
        user_event_1.default.click(
        ...
        expect(
          react_1.screen.getByTestId("how-it-works-content")
        ).toBeInTheDocument();
        user_event_1.default.click(
          react_1.screen.getByTestId("how-it-works-close")
        );
        expect(
          react_1.screen.queryByTestId("how-it-works-content")
        ).not.toBeInTheDocument();
  ...
  describe("controlled mode", function () {
    it("respects an external isOpen=true prop without internal state", function () {
      ...
      expect(
        react_1.screen.queryByTestId("how-it-works-link")
      ).not.toBeInTheDocument();
    });
    ...
    it("invokes onOpenChange(true) when link is clicked in controlled mode", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var onOpenChange;
        return __generator(this, function (_a) {
          onOpenChange = jest.fn();
          (0,
          react_1.render)(<HowItWorks_1.default isOpen={false} onOpenChange={onOpenChange} />);
          user_event_1.default.click(
            react_1.screen.getByTestId("how-it-works-link")
          );
    ...
    it("invokes onOpenChange(false) when close button is clicked in controlled mode", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var onOpenChange;
        return __generator(this, function (_a) {
          onOpenChange = jest.fn();
          (0,
          react_1.render)(<HowItWorks_1.default isOpen={true} onOpenChange={onOpenChange} />);
          user_event_1.default.click(
            react_1.screen.getByTestId("how-it-works-close")
          );
    ...
    it("does not toggle internally when controlled (parent must update isOpen)", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var onOpenChange;
        return __generator(this, function (_a) {
          onOpenChange = jest.fn();
    ...
    it("calls onOpenChange in uncontrolled mode as well (when provided)", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var onOpenChange;
        return __generator(this, function (_a) {
          onOpenChange = jest.fn();
          (0,
          react_1.render)(<HowItWorks_1.default onOpenChange={onOpenChange} />);
          user_event_1.default.click(
            react_1.screen.getByTestId("how-it-works-link")
          );
          expect(onOpenChange).toHaveBeenCalledWith(true);
