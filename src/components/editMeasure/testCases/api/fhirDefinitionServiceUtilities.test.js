...
describe("buildFullValidationSchema", function () {
  ...
  it("excludes abstract choice-type ([x]) keys from the shape but enforces the required choice via a concrete variant", function () {
    var formInfo = {
    ...
    var schema = (0, fhirDefinitionServiceUtilities_1.buildSchemaRecursive)(
      formInfo,
      "Coverage.costToBeneficiary[0]"
    );
    ...
    expect(function () {
      return schema.validateSync(invalidData);
