...
const deleteToken = "FDE8472A-6095-4292-ABF7-E35AD435F05F"; // randomly generated token for deleting (must match QICoreStratifications.deleteToken)
            ...
            <>
              ...
              <div tw="mb-5">
                ...
                {activeTab === "stratification" && (
                  <QICoreStratifications
                    formik={formik}
                    canEdit={canEdit}
                    stratificationOptions={stratificationOptions}
                    stratAssociation={stratAssociation}
